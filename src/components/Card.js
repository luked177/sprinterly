...
const Card = React.forwardRef(({ className, ...props }, ref) => <div ref={ref} className={cn("rounded-lg border bg-background text-card-foreground shadow-sm", className)} {...props} />);
